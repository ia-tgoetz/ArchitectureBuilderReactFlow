...
| `waypoints` | array | Explicit orthogonal routing waypoints `[{x, y}, ...]`. Empty array means auto-routed; populated after the first segment drag. Right-click → Clear Path resets to auto-routing. |
